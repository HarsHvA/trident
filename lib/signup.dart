          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  FadeAnimation(1.2,makeInput(label:"Email",controller:emailTxtController)),
                  FadeAnimation(1.3, makeInput(label:"Name",controller:nameTxtController)),
                  FadeAnimation(1.4, makeInput(label:"Password",obscureText: true, controller:passwordTxtController)),
              ...
              FadeAnimation(1.5, Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    Toast.show("Email:"+emailTxtController.text.toString()
                    +" Name: "+nameTxtController.text.toString()+" Password: "
